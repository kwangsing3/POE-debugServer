...
var defaultCharactList = []model.Character{
	{
...
var defaultLeague = []model.League{
	{
		ID:          `Standard`,
		Realm:       `pc`,
...
var characterList = module.NewCharacterList(10)
